...
/****** Object:  Database [ProjectTracking]    Script Date: 25.11.2019 23:13:20 ******/
DROP DATABASE [ProjectTracking]
GO
...
CREATE DATABASE [ProjectTracking]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ProjectTracking', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\ProjectTracking.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ProjectTracking_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\ProjectTracking_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
